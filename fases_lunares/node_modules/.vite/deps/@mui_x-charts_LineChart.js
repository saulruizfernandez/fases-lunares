...
var ClassNameConfiguratorContext = React41.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass3) {
  ...
  } = React41.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
var InteractionContext = React44.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React44.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
var HighlightedContext = React45.createContext({
...
function useSeries() {
  const series = React46.useContext(SeriesContext);
  if (series === void 0) {
...
function HighlightedProvider({
  ...
  const seriesById = React47.useMemo(() => {
  ...
  const providerValue = React47.useMemo(() => {
    return {
      highlightScope,
      highlightedItem,
...
function useItemHighlighted(item) {
  const highlighted = React49.useContext(HighlightedContext);
...
var ZAxisContext = React50.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React50.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React54.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React58.Fragment, {
    children: [(0, import_jsx_runtime22.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime22.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      })
    }), (0, import_jsx_runtime22.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime22.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(Area, _extends({}, other, areaProps));
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime24.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime24.jsxs)(React60.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React62.useContext(DrawingContext);
  return React62.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var _excluded24 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime27.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime27.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color3,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React64.Fragment, {
    children: [(0, import_jsx_runtime28.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime28.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime28.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime30.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime30.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color3,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React67.useRef({
    x: -1,
    y: -1
  });
  React67.useEffect(() => {
...
var _excluded28 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
var ChartChartsSurfaceStyles = styled_default2("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React68.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
function MarkPlot(props) {
  ...
  const seriesData = React73.useContext(SeriesContext).line;
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime35.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime35.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded33 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded33);
  const _ref = styleProps ?? {}, {
    angle,
    textAnchor,
    dominantBaseline
  } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded210);
  const wordsByLines = React74.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime36.jsx)("text", _extends({}, textProps, {
    x: x2,
    y: y2,
    textAnchor,
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime36.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types34.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types34.default.bool,
   ...
   * Text displayed.
   */
  text: import_prop_types34.default.string.isRequired
} : void 0;
...
var _excluded34 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React76.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded34);
...
var _excluded35 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const {
    yAxisIds
  } = React77.useContext(CartesianContext);
  const _React$useContext = React77.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded35);
  ...
  return (0, import_jsx_runtime38.jsxs)(AxisRoot, {
    transform: `translate(${position3 === "right" ? left3 + width2 : left3}, 0)`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime38.jsx)(Line, _extends({
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      className: classes.line
      ...
      return (0, import_jsx_runtime38.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime38.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime38.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime38.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime38.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React78.Fragment, {
    children: [topId && (0, import_jsx_runtime39.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime39.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime39.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime39.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
var Portal = React79.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React79.useState(null);
  const handleRef = useForkRef(React79.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React79.isValidElement(children)) {
      ...
      return React79.cloneElement(children, newProps);
    }
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(React81.Fragment, {
...
function useMouseTracker() {
  const svgRef = React82.useContext(SvgContext);
  const [mousePosition, setMousePosition] = React82.useState(null);
  React82.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types41.default.func.isRequired,
  /**
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types42.default.shape({
    ...
    getColor: import_prop_types42.default.func,
    ...
    series: import_prop_types42.default.object,
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React87.useContext(CartesianContext);
  const {
    zAxisIds,
    zAxis
  } = React87.useContext(ZAxisContext);
  const series = React87.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React87.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React87.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types45.default.shape({
    x: import_prop_types45.default.shape({
      index: import_prop_types45.default.number,
      value: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number, import_prop_types45.default.string]).isRequired
    }),
    y: import_prop_types45.default.shape({
      index: import_prop_types45.default.number,
      value: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number, import_prop_types45.default.string]).isRequired
    })
  }).isRequired,
  ...
  contentProps: import_prop_types45.default.shape({
    axis: import_prop_types45.default.object,
    axisData: import_prop_types45.default.shape({
      x: import_prop_types45.default.shape({
        index: import_prop_types45.default.number,
        value: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number, import_prop_types45.default.string]).isRequired
    ...
    axisValue: import_prop_types45.default.oneOfType([import_prop_types45.default.instanceOf(Date), import_prop_types45.default.number, import_prop_types45.default.string]),
    classes: import_prop_types45.default.object,
    dataIndex: import_prop_types45.default.number,
    series: import_prop_types45.default.arrayOf(import_prop_types45.default.object),
...
var _excluded38 = ["rotate", "dominantBaseline"];
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React89.useMemo(
  ...
  const padding2 = React89.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React89.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded38);
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React89.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  drawingArea: import_prop_types47.default.shape({
    bottom: import_prop_types47.default.number.isRequired,
    height: import_prop_types47.default.number.isRequired,
    left: import_prop_types47.default.number.isRequired,
    right: import_prop_types47.default.number.isRequired,
  ...
  series: import_prop_types47.default.object.isRequired,
  seriesToDisplay: import_prop_types47.default.arrayOf(import_prop_types47.default.shape({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React91.Fragment, {
...
true ? ChartsClipPath.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  id: import_prop_types50.default.string.isRequired,
  offset: import_prop_types50.default.shape({
...
var _excluded39 = ["x", "y", "id", "classes", "color"];
...
var _excluded40 = ["slots", "slotProps"];
function LineHighlightPlot(props) {
  ...
  const seriesData = React94.useContext(SeriesContext).line;
  const axisData = React94.useContext(CartesianContext);
  const {
    axis
...
var _excluded41 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  const {
    vertical,
    horizontal
  } = themeProps, other = _objectWithoutPropertiesLoose(themeProps, _excluded41);
  const {
    xAxis,
    xAxisIds,
    yAxis,
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React96.useContext(SvgContext);
  const series = React96.useContext(SeriesContext);
  const {
    axis
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React96.useContext(CartesianContext);
  React96.useEffect(() => {
    const element = svgRef.current;
  ...
  return (0, import_jsx_runtime56.jsx)(React96.Fragment, {});
}
...
var LineChart = React100.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
...
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types55.default.shape({
    x: import_prop_types55.default.oneOf(["band", "line", "none"]),
    y: import_prop_types55.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types55.default.oneOfType([import_prop_types55.default.object, import_prop_types55.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types55.default.oneOfType([import_prop_types55.default.arrayOf(import_prop_types55.default.string), import_prop_types55.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types55.default.arrayOf(import_prop_types55.default.object),
   ...
   */
  disableLineItemHighlight: import_prop_types55.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types55.default.shape({
    horizontal: import_prop_types55.default.bool,
    vertical: import_prop_types55.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types55.default.shape({
    dataIndex: import_prop_types55.default.number,
    seriesId: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types55.default.oneOfType([import_prop_types55.default.object, import_prop_types55.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types55.default.shape({
    classes: import_prop_types55.default.object,
    direction: import_prop_types55.default.oneOf(["column", "row"]),
    hidden: import_prop_types55.default.bool,
    position: import_prop_types55.default.shape({
      horizontal: import_prop_types55.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types55.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   */
  onAreaClick: import_prop_types55.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types55.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   */
  onLineClick: import_prop_types55.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types55.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types55.default.oneOfType([import_prop_types55.default.object, import_prop_types55.default.string]),
  /**
   * The series to display in the line chart.
   * An array of [[LineSeriesType]] objects.
   */
  series: import_prop_types55.default.arrayOf(import_prop_types55.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
   ...
   */
  tooltip: import_prop_types55.default.shape({
    axisContent: import_prop_types55.default.elementType,
    classes: import_prop_types55.default.object,
    itemContent: import_prop_types55.default.elementType,
    slotProps: import_prop_types55.default.object,
    slots: import_prop_types55.default.object,
    trigger: import_prop_types55.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types55.default.oneOfType([import_prop_types55.default.object, import_prop_types55.default.string]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types55.default.arrayOf(import_prop_types55.default.shape({
    axisId: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
    classes: import_prop_types55.default.object,
    colorMap: import_prop_types55.default.oneOfType([import_prop_types55.default.shape({
      colors: import_prop_types55.default.arrayOf(import_prop_types55.default.string).isRequired,
      type: import_prop_types55.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types55.default.string,
      values: import_prop_types55.default.arrayOf(import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number, import_prop_types55.default.string]).isRequired)
    }), import_prop_types55.default.shape({
      color: import_prop_types55.default.oneOfType([import_prop_types55.default.arrayOf(import_prop_types55.default.string.isRequired), import_prop_types55.default.func]).isRequired,
      max: import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number]),
      min: import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number]),
      type: import_prop_types55.default.oneOf(["continuous"]).isRequired
    }), import_prop_types55.default.shape({
      colors: import_prop_types55.default.arrayOf(import_prop_types55.default.string).isRequired,
      thresholds: import_prop_types55.default.arrayOf(import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number]).isRequired).isRequired,
      type: import_prop_types55.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types55.default.array,
    dataKey: import_prop_types55.default.string,
    disableLine: import_prop_types55.default.bool,
    disableTicks: import_prop_types55.default.bool,
    fill: import_prop_types55.default.string,
    hideTooltip: import_prop_types55.default.bool,
    ...
    labelFontSize: import_prop_types55.default.number,
    labelStyle: import_prop_types55.default.object,
    max: import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number]),
    min: import_prop_types55.default.oneOfType([import_prop_types55.default.instanceOf(Date), import_prop_types55.default.number]),
    position: import_prop_types55.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types55.default.bool,
    scaleType: import_prop_types55.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types55.default.object,
    slots: import_prop_types55.default.object,
    stroke: import_prop_types55.default.string,
    tickFontSize: import_prop_types55.default.number,
    tickInterval: import_prop_types55.default.oneOfType([import_prop_types55.default.oneOf(["auto"]), import_prop_types55.default.array, import_prop_types55.default.func]),
    tickLabelInterval: import_prop_types55.default.oneOfType([import_prop_types55.default.oneOf(["auto"]), import_prop_types55.default.func]),
    tickLabelPlacement: import_prop_types55.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types55.default.object,
    tickMaxStep: import_prop_types55.default.number,
    tickMinStep: import_prop_types55.default.number,
    tickNumber: import_prop_types55.default.number,
    tickPlacement: import_prop_types55.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types55.default.number,
    valueFormatter: import_prop_types55.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types55.default.arrayOf(import_prop_types55.default.shape({
    axisId: import_prop_types55.default.oneOfType([import_prop_types55.default.number, import_prop_types55.default.string]),
    classes: import_prop_types55.default.object,
    colorMap: import_prop_types55.default.oneOfType([import_prop_types55.default.shape({
      colors: import_prop_types55.default.arrayOf(import_prop_types55.default.string).isRequired,
